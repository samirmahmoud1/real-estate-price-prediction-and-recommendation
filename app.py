...
def page_home():
    ...
    with c1:
        ...
        <div class='glass-card'>
            ...
            <div class='card-text'>
                Estimate property value using comparable listings and market-aware pricing logic.
            </div>
        </div>
        """, unsafe_allow_html=True)
    with c2:
        ...
        <div class='glass-card'>
            ...
            <div class='card-text'>
                Discover the best properties and areas based on budget, ROI, growth, and price efficiency.
            </div>
        </div>
        """, unsafe_allow_html=True)
    with c3:
        ...
        <div class='glass-card'>
            ...
            <div class='card-text'>
                Explore market density, area behavior, and recommendation results on interactive maps.
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with k4:
        ...
        <div class='kpi-box'>
            ...
            <div class='kpi-value' style='font-size:1.35rem;'>Prediction + Advice</div>
        </div>
        """, unsafe_allow_html=True)

    st.markdown(
        "<div class='info-banner'>Use the sidebar to navigate between prediction, recommendation, analytics, and project details.</div>",
        unsafe_allow_html=True,
    )
...
def page_business_prediction():
    ...
    if st.button("Predict Business Price"):
        ...
        with c2:
            st.metric("Median Comparable Price", format_currency(median_price))
        with c3:
            st.metric("Comparable Properties Used", f"{len(comps)}")

        status = get_market_status(predicted_price, median_price)
        st.markdown(f"""
        <div class='glass-card'>
            <div class='card-title'>Smart Insight</div>
        ...
        comp_cols = [c for c in [
            ...
            "bathrooms", "livingRooms", "latitude", "longitude"
...
def page_clean_model():
    ...
    with col1:
        st.markdown("""
        <div class='glass-card'>
            <div class='card-title'>Why is it clean?</div>
            <div class='card-text'>
                The clean model excludes target-derived leakage features and focuses on realistic structural and location-based attributes.
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class='glass-card'>
            ...
            <div class='card-text'>
                ...
                This is a strong and realistic result for a clean property pricing model.
            </div>
        </div>
        """, unsafe_allow_html=True)
...
def page_investment_advisor():
    ...
    if st.button("Get Smart Recommendations"):
        ...
        display_cols = [col for col in [
            "saleEstimate_currentPrice", "ROI", "growth_rate", "floorAreaSqM",
...
def page_analytics_dashboard():
    ...
    with col1:
        st.metric("Average Price", format_currency(mean_price))
    with col2:
